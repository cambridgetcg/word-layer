...
- Preserve the five-stage Word operation registry in `src/protocol.ts`; MCP,
...
- Resolution and selection must not call Browser. Planning must remain
  zero-effect. Open is attempted once and is never retried automatically.
